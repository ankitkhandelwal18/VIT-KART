...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='add_user.php'"><span class="glyphicon glyphicon-edit pull-left"></span> Add User </button></li>
